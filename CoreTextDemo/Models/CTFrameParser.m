...
static CGFloat ascentCallback(void *ref){
    return AdaptedHeightValue([(NSNumber*)[(__bridge NSDictionary*)ref objectForKey:@"height"] floatValue]);
}
...
static CGFloat widthCallback(void* ref){
    return AdaptedWidthValue([(NSNumber*)[(__bridge NSDictionary*)ref objectForKey:@"width"] floatValue]);
}
...
+ (CoreTextData *)parseTemplateFile:(NSString *)path config:(CTFrameParserConfig*)config {
    ...
    NSAttributedString *content = [self loadTemplateFile:path dataArray:nil config:config
...
+ (CoreTextData *)parseTemplateData:(NSArray *)dataArray config:(CTFrameParserConfig *)config {
    NSMutableArray *imageArray = [NSMutableArray array];
    NSMutableArray *linkArray = [NSMutableArray array];
    NSAttributedString *content = [self loadTemplateFile:nil dataArray:dataArray config:config
                                              imageArray:imageArray linkArray:linkArray];
    CoreTextData *textData = [self parseAttributedContent:content config:config];
...
+ (UIColor *)colorFromTemplate:(NSString *)name {
    if ([name isEqualToString:@"default"]) {
        ...
        return UIColorFromRGB(baseColor);
